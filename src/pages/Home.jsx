...
import { Link, useLocation } from 'react-router-dom'; // Ajout de useLocation pour le scroll
...
export default function Home() {
  ...
  // --- FORCE LE RETOUR EN HAUT DE PAGE AU CHANGEMENT DE LIEN ---
  useEffect(() => {
    window.scrollTo(0, 0);
  }, [pathname]);
  ...
  return (
    <div className="font-sans">
      ...
      <div className="relative z-10 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
        ...
        {/* --- HERO SLIDER (DÉZOOMÉ & AJUSTÉ) --- */}
        <div className="relative h-[75vh] md:h-screen flex items-center justify-center overflow-hidden bg-[#57534e]">
          {slides.map((slide, index) => (
            ...
            >
              <img 
                ...
                className="w-full h-full object-contain md:object-cover opacity-60 scale-90 md:scale-100 transition-transform duration-700"
              />
            </div>
          ))}
          
          <div className="relative z-10 text-center text-white px-4 reveal active">
            <p className="text-[10px] md:text-base uppercase tracking-[0.4em] mb-6 font-light">
            ...
            <Link 
              to="/reservation" 
              className="inline-block border border-white text-white px-8 py-3 md:px-10 md:py-4 uppercase text-[10px] md:text-xs tracking-[0.2em] hover:bg-white hover:text-[#57534e] transition-all duration-500"
            >
              Prendre Rendez-vous
            </Link>
          </div>
        ...
        <section className="py-24 px-4 md:px-0 max-w-7xl mx-auto border-b border-[#e7e5e4]">
          <div className="flex flex-col md:flex-row items-center reveal">
            <div className="md:w-1/2 md:pr-16 md:pl-8 mb-12 md:mb-0 text-left">
              ...
              <p className="text-[#57534e] leading-relaxed mb-6 font-light">L'expertise Signature Wellness : un accompagnement post-chirurgie optimal.</p>
        ...
        <section className="py-24 px-4 md:px-0 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row-reverse items-center reveal">
            <div className="md:w-1/2 md:pl-16 md:pr-8 mb-12 md:mb-0 text-left">
              ...
              <p className="text-[#57534e] leading-relaxed mb-6 font-light">Dites adieu aux poils indésirables grâce à notre technologie laser.</p>
      ...
      {/* --- L'EFFET RIDEAU (PARALLAXE DÉZOOMÉ) --- */}
      <section className="relative w-full h-[65vh] md:h-[85vh] overflow-hidden bg-[#57534e]">
        <div className="absolute inset-0 z-0">
          <img 
            src={imgParallax} 
            className="w-full h-full object-contain md:object-cover fixed top-0 left-0 -z-10 opacity-80" 
            alt="Fond Parallaxe" 
          />
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center text-white px-4">
          <div className="max-w-4xl">
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] mb-4 block">Neuilly-sur-Seine</span>
            ...
            <Link to="/reservation" className="inline-block bg-white text-[#57534e] px-12 py-4 uppercase text-[10px] font-bold tracking-[0.2em] hover:bg-[#57534e] hover:text-white transition-colors shadow-2xl">
      ...
      <div className="relative z-10 bg-white pt-24 pb-12 overflow-hidden reveal">
         <div className="text-center mb-12">
            <p className="text-[#78716c] text-[10px] uppercase tracking-[0.3em] mb-2">Rejoignez-nous</p>
            <a href="https://instagram.com/Signature_Wellness" target="_blank" rel="noreferrer" className="text-2xl text-[#57534e]" style={{ fontFamily: "'Tenor Sans', sans-serif" }}>
              @Signature_Wellness
            </a>
         </div>
